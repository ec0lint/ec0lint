...
module.exports = {
    meta: {
        ...
        messages: {
            unexpected: "{{ name }} can be removed from your code and replaced by fetch (you can find examples on http://ec0lint.com/features/lighter-http). CO2 Reduction: up to 0.21 g"
        },
        schema: [] // no options,
    },
    create(context) {
