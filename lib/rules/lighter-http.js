...
module.exports = {
    meta: {
        ...
        docs: {
            description: "disallow importing axios and other heavy http libraries",
            category: "Possible Errors",
            recommended: true
        },
        messages: {
            unexpected: "Do not import axios. Use fetch instead (you can find examples on www.ec0lint.com)."
        },
        schema: [] // no options,
    },
    create(context) {
