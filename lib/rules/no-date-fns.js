...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: false,
            url: "https://eslint.org/docs/rules/no-date-fns"
        },
        messages: {
            suggestion: "date-fns can be replaced with Intl.DateTimeFormat - it's perfectly supported by all modern browsers and Node.js. CO2 Reduction: 2.32 g"
        },
        schema: [] // no options,
    },
    create(context) {
