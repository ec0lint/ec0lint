...
module.exports = {
    meta: {
        ...
        docs: {
            description: "disallow to stop importing lodash",
            category: "Code improvements",
            recommended: false,
            url: "https://eslint.org/docs/rules/avoid-lodash"
        },
        messages: {
            suggestion: "You can replace most of the lodash methods, for more go to https://youmightnotneed.com/lodash . CO2 Reduction: 0.5 g"
        },
        schema: [] // no options,
    },
    create(context) {
