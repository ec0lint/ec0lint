...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: false,
            url: "https://www.ec0lint.com/features/avoid-lodash",
        },
        messages: {
            suggestion:
                "Lodash methods can be replaced by plain JS code, for examples go to https://youmightnotneed.com/lodash. CO2 Reduction: 0.5 g",
        },
        schema: [], // no options,
    },
    create(context) {
