...
const COMMENTS_IGNORE_PATTERN = /^\s*(?:ec0lint|jshint\s+|jslint\s+|istanbul\s+|globals?\s+|exported\s+|jscs)/u;
...
module.exports = {
    ...
    isDirectiveComment(node) {
        ...
        return (
            node.type === "Line" && comment.indexOf("ec0lint-") === 0 ||
            node.type === "Block" && (
                comment.indexOf("global ") === 0 ||
                comment.indexOf("ec0lint ") === 0 ||
                comment.indexOf("ec0lint-") === 0
            )
        );
    },
