 ...
 * @property {boolean} [useEc0lintrc] False disables looking for .ec0lintrc.* files.
 */
...
function isFixType(x) {
    return x === "directive" || x === "javascript" || x === "css" || x === "resources";
}
...
class ESLintInvalidOptionsError extends Error {
    constructor(messages) {
        ...
        this.code = "EC0LINT_INVALID_OPTIONS";
...
function processOptions({
    ...
    if (fixTypes !== null && !isFixTypeArray(fixTypes)) {
        errors.push("'fixTypes' must be an array of any of \"directive\", \"javascript\", \"css\", and \"resources\".");
    }
    ...
    if (typeof useEc0lintrc !== "boolean") {
        errors.push("'useEc0lintrc' must be a boolean.");
    }
...
class ESLint {
     ...
     *   - `foo` → `ec0lint-formatter-foo`
     *   - `@foo` → `@foo/ec0lint-formatter`
     *   - `@foo/bar` → `@foo/ec0lint-formatter-bar`
