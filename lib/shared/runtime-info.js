...
function environment() {
    ...
    function getNpmPackageVersion(pkg, { global = false } = {}) {
        ...
        const npmLsArgs = ["ls", "--depth=0", "--json", "ec0lint"];
        ...
        try {
             ...
             */
            if (Object.keys(parsedStdout).length === 0 || !(parsedStdout.dependencies && parsedStdout.dependencies.ec0lint)) {
                return "Not found";
            }
            ...
            let pkgVersion = parsedStdout.dependencies.ec0lint.version;
    ...
    return [
        ...
        `Local ec0lint version: ${getNpmPackageVersion("ec0lint", { global: false })}`,
        `Global ec0lint version: ${getNpmPackageVersion("ec0lint", { global: true })}`,
