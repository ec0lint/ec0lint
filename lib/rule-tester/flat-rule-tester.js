...
/* ec0lint-env mocha -- Mocha/Jest wrapper */
...
function sanitize(text) {
    ...
    return text.replace(
        /[\u0000-\u0009\u000b-\u001a]/gu, // ec0lint-disable-line no-control-regex -- Escaping controls
    ...
    run(ruleName, rule, test) {
        ...
        function runRuleForItem(item) {
            ...
            try {
                ...
                error.message = `ec0lint configuration in rule-tester is invalid: ${error.message}`;
                throw error;
            }
