    ...
    invalid: [
        {
            ...
            errors: [{ message: "Do not import axios. Remove it from your app and use fetch instead(you can find examples on www.ec0lint.com)." }]
        },
        {
        ...
        },
        {
            ...
            errors: [{ message: "Do not import got. Remove it from your app and use fetch instead(you can find examples on www.ec0lint.com)." }]
        },
        {
        ...
        },
        {
            ...
            errors: [{ message: "Do not import request. Remove it from your app and use fetch instead(you can find examples on www.ec0lint.com)." }]
        },
        {
        ...
        },
        {
            ...
            errors: [{ message: "Do not import make-fetch-happen. Remove it from your app and use fetch instead(you can find examples on www.ec0lint.com)." }]
        },
        {
        ...
        },
        {
            ...
            errors: [{ message: "Do not import superagent. Remove it from your app and use fetch instead(you can find examples on www.ec0lint.com)." }]
        },
        {
        ...
        },
        {
            ...
            errors: [{ message: "Do not import needle. Remove it from your app and use fetch instead(you can find examples on www.ec0lint.com)." }]
        },
        {
        ...
        },
        {
            ...
            errors: [{ message: "Do not import simple-get. Remove it from your app and use fetch instead(you can find examples on www.ec0lint.com)." }]
        },
        {
